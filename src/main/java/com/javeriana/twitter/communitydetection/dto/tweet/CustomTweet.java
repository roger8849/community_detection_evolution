...
@Document(collection = "custom_tweets")
public class CustomTweet implements Serializable {
  ...
  private CustomTweet retweetedStatus;
   ...
   */
  @Deprecated
  public CustomTweet(long id, String text, Date createdAt, String fromUser, String profileImageUrl, Long toUserId, long fromUserId, String languageCode, String source) {
   ...
   * @deprecated Use other constructor with String ID instead.
   */
  public CustomTweet(long id, String idStr, String text, Date createdAt, String fromUser, String profileImageUrl, Long toUserId, long fromUserId, String languageCode, String source) {
    this.id = id;
    this.idStr = idStr;
    this.text = text;
  ...
  public CustomTweet getRetweetedStatus() {
    return this.retweetedStatus;
  }

  public void setRetweetedStatus(final CustomTweet tweet) {
  ...
  public boolean equals(Object o) {
    ...
    CustomTweet tweet = (CustomTweet) o;
